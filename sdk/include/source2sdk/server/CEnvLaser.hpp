...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlSymbolLarge m_iszLaserTarget; // 0x888            
            source2sdk::server::CSprite* m_pSprite; // 0x890            
            CUtlSymbolLarge m_iszSpriteName; // 0x898            
            Vector m_firePosition; // 0x8a0            
            float m_flStartFrame; // 0x8ac            
        ...
        static_assert(sizeof(source2sdk::server::CEnvLaser) == 0x8b0);
    };
};
