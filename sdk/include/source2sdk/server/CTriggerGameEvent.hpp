...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlString m_strStartTouchEventName; // 0x9b8            
            // metadata: MNetworkEnable
            CUtlString m_strEndTouchEventName; // 0x9c0            
            // metadata: MNetworkEnable
            CUtlString m_strTriggerID; // 0x9c8            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerGameEvent) == 0x9d0);
    };
};
