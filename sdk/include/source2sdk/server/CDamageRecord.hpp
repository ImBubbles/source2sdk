...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iBulletsDamage) == 0x60);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iDamage) == 0x64);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iActualHealthRemoved) == 0x68);
