...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::uint8_t m_ActualFlags; // 0x7e8            
            // metadata: MNetworkEnable
            std::uint8_t m_Flags; // 0x7e9            
            // metadata: MNetworkEnable
            std::uint8_t m_LightStyle; // 0x7ea            
            bool m_On; // 0x7eb            
            // metadata: MNetworkEnable
            float m_Radius; // 0x7ec            
            // metadata: MNetworkEnable
            std::int32_t m_Exponent; // 0x7f0            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            float m_InnerAngle; // 0x7f4            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            float m_OuterAngle; // 0x7f8            
            // metadata: MNetworkEnable
            float m_SpotRadius; // 0x7fc            
        ...
        static_assert(sizeof(source2sdk::server::CDynamicLight) == 0x800);
    };
};
