...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::uint32_t m_boneIndexAttached; // 0xc48            
            // metadata: MNetworkEnable
            std::uint32_t m_ragdollAttachedObjectIndex; // 0xc4c            
            // metadata: MNetworkEnable
