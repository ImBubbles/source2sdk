...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hLastWeaponBeforeC4AutoSwitch[0x4]; // 0x1f0            
            uint8_t _pad01f4[0x28]; // 0x1f4
            // metadata: MNetworkEnable
            bool m_bIsRescuing; // 0x21c            
            uint8_t _pad021d[0x3]; // 0x21d
            // metadata: MNetworkEnable
            source2sdk::server::WeaponPurchaseTracker_t m_weaponPurchasesThisMatch; // 0x220            
            // metadata: MNetworkEnable
            source2sdk::server::WeaponPurchaseTracker_t m_weaponPurchasesThisRound; // 0x290            
            uint8_t _pad0300[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayer_ActionTrackingServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCSPlayer_ActionTrackingServices) == 0x308);
    };
};
