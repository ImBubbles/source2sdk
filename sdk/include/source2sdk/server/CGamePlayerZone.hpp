...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnPlayerInZone; // 0x7f0            
            source2sdk::entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x818            
            ...
            char m_PlayersInCount[0x28]; // 0x840            
            ...
            char m_PlayersOutCount[0x28]; // 0x868            
        ...
        static_assert(sizeof(source2sdk::server::CGamePlayerZone) == 0x890);
    };
};
