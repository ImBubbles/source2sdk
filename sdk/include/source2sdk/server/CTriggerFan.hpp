...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vFanOrigin; // 0x9b8            
            // metadata: MNetworkEnable
            Vector m_vFanOriginOffset; // 0x9c4            
            // metadata: MNetworkEnable
            Vector m_vFanEnd; // 0x9d0            
            // metadata: MNetworkEnable
            Vector m_vNoiseDirectionTarget; // 0x9dc            
            // metadata: MNetworkEnable
            Vector m_vDirection; // 0x9e8            
            // metadata: MNetworkEnable
            bool m_bPushTowardsInfoTarget; // 0x9f4            
            // metadata: MNetworkEnable
            bool m_bPushAwayFromInfoTarget; // 0x9f5            
