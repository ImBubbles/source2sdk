...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            matrix3x4_t m_matPanelTransform; // 0x7e8            
            matrix3x4_t m_matPanelTransformWsTemp; // 0x818            
            ...
            char m_vecShatterGlassShards[0x18]; // 0x848            
            Vector2D m_PanelSize; // 0x860            
            source2sdk::entity2::GameTime_t m_flLastShatterSoundEmitTime; // 0x868            
            source2sdk::entity2::GameTime_t m_flLastCleanupTime; // 0x86c            
            source2sdk::entity2::GameTime_t m_flInitAtTime; // 0x870            
            float m_flGlassThickness; // 0x874            
            float m_flSpawnInvulnerability; // 0x878            
            bool m_bBreakSilent; // 0x87c            
            bool m_bBreakShardless; // 0x87d            
            bool m_bBroken; // 0x87e            
            bool m_bGlassNavIgnore; // 0x87f            
            bool m_bGlassInFrame; // 0x880            
            bool m_bStartBroken; // 0x881            
            std::uint8_t m_iInitialDamageType; // 0x882            
            uint8_t _pad0883[0x5]; // 0x883
            CUtlSymbolLarge m_szDamagePositioningEntityName01; // 0x888            
            CUtlSymbolLarge m_szDamagePositioningEntityName02; // 0x890            
            CUtlSymbolLarge m_szDamagePositioningEntityName03; // 0x898            
            CUtlSymbolLarge m_szDamagePositioningEntityName04; // 0x8a0            
            ...
            char m_vInitialDamagePositions[0x18]; // 0x8a8            
            ...
            char m_vExtraDamagePositions[0x18]; // 0x8c0            
            ...
            char m_vInitialPanelVertices[0x18]; // 0x8d8            
            source2sdk::entity2::CEntityIOOutput m_OnBroken; // 0x8f0            
            std::uint8_t m_iSurfaceType; // 0x918            
            ...
            char m_hMaterialDamageBase[0x8]; // 0x920            
        ...
        static_assert(sizeof(source2sdk::server::CFuncShatterglass) == 0x928);
    };
};
