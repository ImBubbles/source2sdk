...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_messageText[512]; // 0x7e8            
            // metadata: MNetworkEnable
            char m_FontName[64]; // 0x9e8            
            // metadata: MNetworkEnable
            char m_BackgroundMaterialName[64]; // 0xa28            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            bool m_bDrawBackground; // 0xa78            
            uint8_t _pad0a79[0x3]; // 0xa79
            // metadata: MNetworkEnable
            float m_flBackgroundBorderWidth; // 0xa7c            
            // metadata: MNetworkEnable
            float m_flBackgroundBorderHeight; // 0xa80            
            // metadata: MNetworkEnable
            float m_flBackgroundWorldToUV; // 0xa84            
            // metadata: MNetworkEnable
            Color m_Color; // 0xa88            
            // metadata: MNetworkEnable
            source2sdk::client::PointWorldTextJustifyHorizontal_t m_nJustifyHorizontal; // 0xa8c            
            // metadata: MNetworkEnable
            source2sdk::client::PointWorldTextJustifyVertical_t m_nJustifyVertical; // 0xa90            
            // metadata: MNetworkEnable
            source2sdk::client::PointWorldTextReorientMode_t m_nReorientMode; // 0xa94            
        ...
        static_assert(sizeof(source2sdk::server::CPointWorldText) == 0xa98);
    };
};
