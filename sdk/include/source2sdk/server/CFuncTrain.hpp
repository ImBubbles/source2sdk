...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hCurrentTarget[0x4]; // 0x890            
            bool m_activated; // 0x894            
            ...
            char m_hEnemy[0x4]; // 0x898            
            float m_flBlockDamage; // 0x89c            
            source2sdk::entity2::GameTime_t m_flNextBlockTime; // 0x8a0            
            uint8_t _pad08a4[0x4]; // 0x8a4
            CUtlSymbolLarge m_iszLastTarget; // 0x8a8            
        ...
        static_assert(sizeof(source2sdk::server::CFuncTrain) == 0x8b0);
    };
};
