...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_flexWeight[0x18]; // 0xa78            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            Vector m_vLookTargetPosition; // 0xa90            
            // metadata: MNetworkEnable
            bool m_blinktoggle; // 0xa9c            
            uint8_t _pad0a9d[0x53]; // 0xa9d
            source2sdk::entity2::GameTime_t m_flAllowResponsesEndTime; // 0xaf0            
            source2sdk::entity2::GameTime_t m_flLastFlexAnimationTime; // 0xaf4            
            source2sdk::client::SceneEventId_t m_nNextSceneEventId; // 0xaf8            
            bool m_bUpdateLayerPriorities; // 0xafc            
            uint8_t _pad0afd[0xb];
        ...
        static_assert(sizeof(source2sdk::server::CBaseFlex) == 0xb08);
    };
};
