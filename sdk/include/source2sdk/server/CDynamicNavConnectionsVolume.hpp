...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlSymbolLarge m_iszConnectionTarget; // 0x9e0            
            ...
            CGlobalSymbol m_sTransitionType; // 0xa00            
            bool m_bConnectionsEnabled; // 0xa08            
            uint8_t _pad0a09[0x3]; // 0xa09
            float m_flTargetAreaSearchRadius; // 0xa0c            
            float m_flUpdateDistance; // 0xa10            
            float m_flMaxConnectionDistance; // 0xa14            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDynamicNavConnectionsVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDynamicNavConnectionsVolume) == 0xa18);
    };
};
