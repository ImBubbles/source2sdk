...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flFrameRate; // 0x7e8            
            // metadata: MNetworkEnable
            float m_flHDRColorScale; // 0x7ec            
            source2sdk::entity2::GameTime_t m_flFireTime; // 0x7f0            
            float m_flDamage; // 0x7f4            
            // metadata: MNetworkEnable
            std::uint8_t m_nNumBeamEnts; // 0x7f8            
            ...
            char m_hBaseMaterial[0x8]; // 0x800            
            // metadata: MNetworkEnable
            ...
            char m_nHaloIndex[0x8]; // 0x808            
            // metadata: MNetworkEnable
            source2sdk::client::BeamType_t m_nBeamType; // 0x810            
            // metadata: MNetworkEnable
            std::uint32_t m_nBeamFlags; // 0x814            
            // metadata: MNetworkEnable
            ...
            char m_hAttachEntity[0x28]; // 0x818            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0x840            
            ...
            // metadata: MNetworkEncodeFlags "2"
            float m_fWidth; // 0x84c            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "10"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "102,300003"
            // metadata: MNetworkEncodeFlags "2"
            float m_fEndWidth; // 0x850            
            // metadata: MNetworkEnable
            float m_fFadeLength; // 0x854            
            // metadata: MNetworkEnable
            float m_fHaloScale; // 0x858            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "64,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fAmplitude; // 0x85c            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "256,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fStartFrame; // 0x860            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "100,000000"
            float m_fSpeed; // 0x864            
            // metadata: MNetworkEnable
            ...
            float m_flFrame; // 0x868            
            // metadata: MNetworkEnable
            source2sdk::client::BeamClipStyle_t m_nClipStyle; // 0x86c            
            // metadata: MNetworkEnable
            bool m_bTurnedOff; // 0x870            
            uint8_t _pad0871[0x3]; // 0x871
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            Vector m_vecEndPos; // 0x874            
            ...
            char m_hEndEntity[0x4]; // 0x880            
            std::int32_t m_nDissolveType; // 0x884            
        ...
        static_assert(sizeof(source2sdk::server::CBeam) == 0x888);
    };
};
