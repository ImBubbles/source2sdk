...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hDecalMaterial[0x8]; // 0x7e8            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
            float m_flWidth; // 0x7f0            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
            float m_flHeight; // 0x7f4            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
            float m_flDepth; // 0x7f8            
            // metadata: MNetworkEnable
            std::uint32_t m_nRenderOrder; // 0x7fc            
            // metadata: MNetworkEnable
            bool m_bProjectOnWorld; // 0x800            
            // metadata: MNetworkEnable
            bool m_bProjectOnCharacters; // 0x801            
            // metadata: MNetworkEnable
            bool m_bProjectOnWater; // 0x802            
            uint8_t _pad0803[0x1]; // 0x803
            // metadata: MNetworkEnable
            float m_flDepthSortBias; // 0x804            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CEnvDecal because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CEnvDecal) == 0x808);
    };
};
