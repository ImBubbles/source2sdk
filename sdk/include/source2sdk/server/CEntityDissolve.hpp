...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flFadeInStart; // 0x7e8            
            // metadata: MNetworkEnable
            float m_flFadeInLength; // 0x7ec            
            // metadata: MNetworkEnable
            float m_flFadeOutModelStart; // 0x7f0            
            // metadata: MNetworkEnable
            float m_flFadeOutModelLength; // 0x7f4            
            // metadata: MNetworkEnable
            float m_flFadeOutStart; // 0x7f8            
            // metadata: MNetworkEnable
            float m_flFadeOutLength; // 0x7fc            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x800            
            // metadata: MNetworkEnable
            source2sdk::client::EntityDisolveType_t m_nDissolveType; // 0x804            
            // metadata: MNetworkEnable
            Vector m_vDissolverOrigin; // 0x808            
            // metadata: MNetworkEnable
            std::uint32_t m_nMagnitude; // 0x814            
        ...
        static_assert(sizeof(source2sdk::server::CEntityDissolve) == 0x818);
    };
};
