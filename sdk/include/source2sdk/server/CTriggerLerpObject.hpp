...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlSymbolLarge m_iszLerpTarget; // 0x9b8            
            ...
            char m_hLerpTarget[0x4]; // 0x9c0            
            uint8_t _pad09c4[0x4]; // 0x9c4
            CUtlSymbolLarge m_iszLerpTargetAttachment; // 0x9c8            
            source2sdk::modellib::AttachmentHandle_t m_hLerpTargetAttachment; // 0x9d0            
            uint8_t _pad09d1[0x3]; // 0x9d1
            float m_flLerpDuration; // 0x9d4            
            bool m_bLerpRestoreMoveType; // 0x9d8            
            bool m_bSingleLerpObject; // 0x9d9            
            ...
            char m_vecLerpingObjects[0x18]; // 0x9e0            
            CUtlSymbolLarge m_iszLerpEffect; // 0x9f8            
            CUtlSymbolLarge m_iszLerpSound; // 0xa00            
            bool m_bAttachTouchingObject; // 0xa08            
            ...
            char m_hEntityToWaitForDisconnect[0x4]; // 0xa0c            
            source2sdk::entity2::CEntityIOOutput m_OnLerpStarted; // 0xa10            
            source2sdk::entity2::CEntityIOOutput m_OnLerpFinished; // 0xa38            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerLerpObject) == 0xa60);
    };
};
