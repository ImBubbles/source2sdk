...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nVariant; // 0x4f0            
            // metadata: MNetworkEnable
            std::int32_t m_nRandom; // 0x4f4            
            // metadata: MNetworkEnable
            std::int32_t m_nOrdinal; // 0x4f8            
            uint8_t _pad04fc[0x4]; // 0x4fc
            // metadata: MNetworkEnable
            CUtlString m_sWeaponName; // 0x500            
            // metadata: MNetworkEnable
            std::uint64_t m_xuid; // 0x508            
            // metadata: MNetworkEnable
            source2sdk::server::CEconItemView m_agentItem; // 0x510            
            // metadata: MNetworkEnable
            source2sdk::server::CEconItemView m_glovesItem; // 0x7b8            
            // metadata: MNetworkEnable
            source2sdk::server::CEconItemView m_weaponItem; // 0xa60            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSGO_TeamPreviewCharacterPosition because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCSGO_TeamPreviewCharacterPosition) == 0xd08);
    };
};
