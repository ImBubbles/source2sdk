...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::uint32_t m_unTotalRoundDamageDealt; // 0x190            
            uint8_t _pad0194[0xdc];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayerController_ActionTrackingServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCSPlayerController_ActionTrackingServices) == 0x270);
    };
};
