...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CCSPlayerController_InGameMoneyServices* m_pInGameMoneyServices; // 0x800            
            // metadata: MNetworkEnable
            source2sdk::server::CCSPlayerController_InventoryServices* m_pInventoryServices; // 0x808            
            // metadata: MNetworkEnable
            source2sdk::server::CCSPlayerController_ActionTrackingServices* m_pActionTrackingServices; // 0x810            
            // metadata: MNetworkEnable
            source2sdk::server::CCSPlayerController_DamageServices* m_pDamageServices; // 0x818            
            // metadata: MNetworkEnable
            std::uint32_t m_iPing; // 0x820            
            // metadata: MNetworkEnable
            bool m_bHasCommunicationAbuseMute; // 0x824            
            uint8_t _pad0825[0x3]; // 0x825
            // metadata: MNetworkEnable
            std::uint32_t m_uiCommunicationMuteFlags; // 0x828            
            uint8_t _pad082c[0x4]; // 0x82c
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_szCrosshairCodes; // 0x830            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnPendingTeamChanged"
            std::uint8_t m_iPendingTeamNum; // 0x838            
            uint8_t _pad0839[0x3]; // 0x839
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flForceTeamTime; // 0x83c            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnCompTeammateColorChanged"
            std::int32_t m_iCompTeammateColor; // 0x840            
            // metadata: MNetworkEnable
            bool m_bEverPlayedOnTeam; // 0x844            
            bool m_bAttemptedToGetColor; // 0x845            
            uint8_t _pad0846[0x2]; // 0x846
            std::int32_t m_iTeammatePreferredColor; // 0x848            
            bool m_bTeamChanged; // 0x84c            
            bool m_bInSwitchTeam; // 0x84d            
            bool m_bHasSeenJoinGame; // 0x84e            
            bool m_bJustBecameSpectator; // 0x84f            
            bool m_bSwitchTeamsOnNextRoundReset; // 0x850            
            bool m_bRemoveAllItemsOnNextRoundReset; // 0x851            
            uint8_t _pad0852[0x2]; // 0x852
            source2sdk::entity2::GameTime_t m_flLastJoinTeamTime; // 0x854            
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_szClan; // 0x858            
            char m_szClanName[32]; // 0x860            
            // metadata: MNetworkEnable
            std::int32_t m_iCoachingTeam; // 0x880            
            uint8_t _pad0884[0x4]; // 0x884
            // metadata: MNetworkEnable
            std::uint64_t m_nPlayerDominated; // 0x888            
            // metadata: MNetworkEnable
            std::uint64_t m_nPlayerDominatingMe; // 0x890            
            // metadata: MNetworkEnable
            std::int32_t m_iCompetitiveRanking; // 0x898            
            // metadata: MNetworkEnable
            std::int32_t m_iCompetitiveWins; // 0x89c            
            // metadata: MNetworkEnable
            std::int8_t m_iCompetitiveRankType; // 0x8a0            
            uint8_t _pad08a1[0x3]; // 0x8a1
            // metadata: MNetworkEnable
            std::int32_t m_iCompetitiveRankingPredicted_Win; // 0x8a4            
            // metadata: MNetworkEnable
            std::int32_t m_iCompetitiveRankingPredicted_Loss; // 0x8a8            
            // metadata: MNetworkEnable
            std::int32_t m_iCompetitiveRankingPredicted_Tie; // 0x8ac            
            // metadata: MNetworkEnable
            std::int32_t m_nEndMatchNextMapVote; // 0x8b0            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            std::uint16_t m_unActiveQuestId; // 0x8b4            
            uint8_t _pad08b6[0x2]; // 0x8b6
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            std::uint32_t m_rtActiveMissionPeriod; // 0x8b8            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            source2sdk::client::QuestProgress_Reason m_nQuestProgressReason; // 0x8bc            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            std::uint32_t m_unPlayerTvControlFlags; // 0x8c0            
            uint8_t _pad08c4[0x2c]; // 0x8c4
            std::int32_t m_iDraftIndex; // 0x8f0            
            std::uint32_t m_msQueuedModeDisconnectionTimestamp; // 0x8f4            
            std::uint32_t m_uiAbandonRecordedReason; // 0x8f8            
            std::uint32_t m_eNetworkDisconnectionReason; // 0x8fc            
            bool m_bCannotBeKicked; // 0x900            
            bool m_bEverFullyConnected; // 0x901            
            bool m_bAbandonAllowsSurrender; // 0x902            
            bool m_bAbandonOffersInstantSurrender; // 0x903            
            bool m_bDisconnection1MinWarningPrinted; // 0x904            
            bool m_bScoreReported; // 0x905            
            uint8_t _pad0906[0x2]; // 0x906
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            std::int32_t m_nDisconnectionTick; // 0x908            
            uint8_t _pad090c[0xc]; // 0x90c
            // metadata: MNetworkEnable
            bool m_bControllingBot; // 0x918            
            // metadata: MNetworkEnable
            bool m_bHasControlledBotThisRound; // 0x919            
            bool m_bHasBeenControlledByPlayerThisRound; // 0x91a            
            uint8_t _pad091b[0x1]; // 0x91b
            std::int32_t m_nBotsControlledThisRound; // 0x91c            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            bool m_bCanControlObservedBot; // 0x920            
            ...
            char m_hObserverPawn[0x4]; // 0x928            
            std::int32_t m_DesiredObserverMode; // 0x92c            
            CEntityHandle m_hDesiredObserverTarget; // 0x930            
            // metadata: MNetworkEnable
            bool m_bPawnIsAlive; // 0x934            
            uint8_t _pad0935[0x3]; // 0x935
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
            std::uint32_t m_iPawnHealth; // 0x938            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
            std::int32_t m_iPawnArmor; // 0x93c            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
            bool m_bPawnHasDefuser; // 0x940            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "TeammateAndSpectatorExclusive"
            bool m_bPawnHasHelmet; // 0x941            
            // metadata: MNetworkEnable
            std::uint16_t m_nPawnCharacterDefIndex; // 0x942            
            // metadata: MNetworkEnable
            std::int32_t m_iPawnLifetimeStart; // 0x944            
            // metadata: MNetworkEnable
            std::int32_t m_iPawnLifetimeEnd; // 0x948            
            // metadata: MNetworkEnable
            std::int32_t m_iPawnBotDifficulty; // 0x94c            
            // metadata: MNetworkEnable
            ...
            char m_hOriginalControllerOfCurrentPawn[0x4]; // 0x950            
            // metadata: MNetworkEnable
            std::int32_t m_iScore; // 0x954            
            std::int32_t m_iRoundScore; // 0x958            
            std::int32_t m_iRoundsWon; // 0x95c            
            // metadata: MNetworkEnable
            std::uint8_t m_recentKillQueue[8]; // 0x960            
            // metadata: MNetworkEnable
            std::uint8_t m_nFirstKill; // 0x968            
            // metadata: MNetworkEnable
            std::uint8_t m_nKillCount; // 0x969            
            // metadata: MNetworkEnable
            bool m_bMvpNoMusic; // 0x96a            
            uint8_t _pad096b[0x1]; // 0x96b
            // metadata: MNetworkEnable
            std::int32_t m_eMvpReason; // 0x96c            
            // metadata: MNetworkEnable
            std::int32_t m_iMusicKitID; // 0x970            
            // metadata: MNetworkEnable
            std::int32_t m_iMusicKitMVPs; // 0x974            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnMVPCountChanged"
            std::int32_t m_iMVPs; // 0x978            
            std::int32_t m_nUpdateCounter; // 0x97c            
            float m_flSmoothedPing; // 0x980            
            uint8_t _pad0984[0x4]; // 0x984
            source2sdk::server::IntervalTimer m_lastHeldVoteTimer; // 0x988            
            uint8_t _pad0998[0x8]; // 0x998
            bool m_bShowHints; // 0x9a0            
            uint8_t _pad09a1[0x3]; // 0x9a1
            std::int32_t m_iNextTimeCheck; // 0x9a4            
            bool m_bJustDidTeamKill; // 0x9a8            
            bool m_bPunishForTeamKill; // 0x9a9            
            bool m_bGaveTeamDamageWarning; // 0x9aa            
            bool m_bGaveTeamDamageWarningThisRound; // 0x9ab            
            uint8_t _pad09ac[0x4]; // 0x9ac
            double m_dblLastReceivedPacketPlatFloatTime; // 0x9b0            
            source2sdk::entity2::GameTime_t m_LastTeamDamageWarningTime; // 0x9b8            
            source2sdk::entity2::GameTime_t m_LastTimePlayerWasDisconnectedForPawnsRemove; // 0x9bc            
            std::uint32_t m_nSuspiciousHitCount; // 0x9c0            
            std::uint32_t m_nNonSuspiciousHitStreak; // 0x9c4            
            uint8_t _pad09c8[0xa1]; // 0x9c8
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            bool m_bFireBulletsSeedSynchronized; // 0xa69            
            uint8_t _pad0a6a[0x7e];
        ...
        static_assert(sizeof(source2sdk::server::CCSPlayerController) == 0xae8);
    };
};
