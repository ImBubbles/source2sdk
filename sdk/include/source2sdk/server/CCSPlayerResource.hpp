...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bHostageAlive[12]; // 0x4f0            
            // metadata: MNetworkEnable
            bool m_isHostageFollowingSomeone[12]; // 0x4fc            
            // metadata: MNetworkEnable
            CEntityIndex m_iHostageEntityIDs[12]; // 0x508            
            // metadata: MNetworkEnable
            Vector m_bombsiteCenterA; // 0x538            
            // metadata: MNetworkEnable
            Vector m_bombsiteCenterB; // 0x544            
            // metadata: MNetworkEnable
            std::int32_t m_hostageRescueX[4]; // 0x550            
            // metadata: MNetworkEnable
            std::int32_t m_hostageRescueY[4]; // 0x560            
            // metadata: MNetworkEnable
            std::int32_t m_hostageRescueZ[4]; // 0x570            
            // metadata: MNetworkEnable
            bool m_bEndMatchNextMapAllVoted; // 0x580            
            bool m_foundGoalPositions; // 0x581            
        ...
        static_assert(sizeof(source2sdk::server::CCSPlayerResource) == 0x588);
    };
};
