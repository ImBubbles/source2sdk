...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_MaxWeight; // 0x9b8            
            // metadata: MNetworkEnable
            float m_FadeDuration; // 0x9bc            
            // metadata: MNetworkEnable
            float m_Weight; // 0x9c0            
            // metadata: MNetworkEnable
            char m_lookupFilename[512]; // 0x9c4            
            float m_LastEnterWeight; // 0xbc4            
            source2sdk::entity2::GameTime_t m_LastEnterTime; // 0xbc8            
            float m_LastExitWeight; // 0xbcc            
            source2sdk::entity2::GameTime_t m_LastExitTime; // 0xbd0            
            uint8_t _pad0bd4[0x4];
        ...
        static_assert(sizeof(source2sdk::server::CColorCorrectionVolume) == 0xbd8);
    };
};
