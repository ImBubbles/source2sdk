...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hPostSettings[0x8]; // 0x9c8            
            // metadata: MNetworkEnable
            float m_flFadeDuration; // 0x9d0            
            // metadata: MNetworkEnable
            float m_flMinLogExposure; // 0x9d4            
            // metadata: MNetworkEnable
            float m_flMaxLogExposure; // 0x9d8            
            // metadata: MNetworkEnable
            float m_flMinExposure; // 0x9dc            
            // metadata: MNetworkEnable
            float m_flMaxExposure; // 0x9e0            
            // metadata: MNetworkEnable
            float m_flExposureCompensation; // 0x9e4            
            // metadata: MNetworkEnable
            float m_flExposureFadeSpeedUp; // 0x9e8            
            // metadata: MNetworkEnable
            float m_flExposureFadeSpeedDown; // 0x9ec            
            // metadata: MNetworkEnable
            float m_flTonemapEVSmoothingRange; // 0x9f0            
            // metadata: MNetworkEnable
            bool m_bMaster; // 0x9f4            
            // metadata: MNetworkEnable
            bool m_bExposureControl; // 0x9f5            
            uint8_t _pad09f6[0x2];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPostProcessingVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CPostProcessingVolume) == 0x9f8);
    };
};
