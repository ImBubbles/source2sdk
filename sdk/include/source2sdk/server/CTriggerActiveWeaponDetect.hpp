...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnTouchedActiveWeapon; // 0x9b8            
            CUtlSymbolLarge m_iszWeaponClassName; // 0x9e0            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerActiveWeaponDetect) == 0x9e8);
    };
};
