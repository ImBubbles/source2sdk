...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_fArmedTime; // 0x107c            
            // metadata: MNetworkEnable
            bool m_bBombPlacedAnimation; // 0x1080            
            // metadata: MNetworkEnable
            bool m_bIsPlantingViaUse; // 0x1081            
            uint8_t _pad1082[0x6]; // 0x1082
            // metadata: MNetworkEnable
            source2sdk::server::EntitySpottedState_t m_entitySpottedState; // 0x1088            
            std::int32_t m_nSpotRules; // 0x10a0            
            bool m_bPlayedArmingBeeps[7]; // 0x10a4            
        ...
        static_assert(sizeof(source2sdk::server::CC4) == 0x10b0);
    };
};
