...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hMaterial[0x8]; // 0x4f0            
            CUtlStringToken m_sSequenceName; // 0x4f8            
            float m_flDistance; // 0x4fc            
            bool m_bNotInMultiplayer; // 0x500            
        ...
        static_assert(sizeof(source2sdk::server::CInfoProjectedDecal) == 0x508);
    };
};
