...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad0c20[0x28]; // 0xc20
            // metadata: MNetworkEnable
            std::int32_t m_nSmokeEffectTickBegin; // 0xc48            
            // metadata: MNetworkEnable
            bool m_bDidSmokeEffect; // 0xc4c            
            uint8_t _pad0c4d[0x3]; // 0xc4d
            // metadata: MNetworkEnable
            std::int32_t m_nRandomSeed; // 0xc50            
            // metadata: MNetworkEnable
            Vector m_vSmokeColor; // 0xc54            
            // metadata: MNetworkEnable
            Vector m_vSmokeDetonationPos; // 0xc60            
            ...
            char m_VoxelFrameData[0x18]; // 0xc70            
            // metadata: MNetworkEnable
            std::int32_t m_nVoxelFrameDataSize; // 0xc88            
            // metadata: MNetworkEnable
            std::int32_t m_nVoxelUpdate; // 0xc8c            
            source2sdk::entity2::GameTime_t m_flLastBounce; // 0xc90            
            source2sdk::entity2::GameTime_t m_fllastSimulationTime; // 0xc94            
            uint8_t _pad0c98[0x2280]; // 0xc98
            bool m_bExplodeFromInferno; // 0x2f18            
            bool m_bDidGroundScorch; // 0x2f19            
            uint8_t _pad2f1a[0x6];
        ...
        static_assert(sizeof(source2sdk::server::CSmokeGrenadeProjectile) == 0x2f20);
    };
};
