...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTargetEntity[0x4]; // 0x7e8            
            // metadata: MNetworkEnable
            bool m_bState; // 0x7ec            
            // metadata: MNetworkEnable
            bool m_bAlwaysUpdate; // 0x7ed            
            uint8_t _pad07ee[0x2]; // 0x7ee
            // metadata: MNetworkEnable
            float m_flLightFOV; // 0x7f0            
            // metadata: MNetworkEnable
            bool m_bEnableShadows; // 0x7f4            
            // metadata: MNetworkEnable
            bool m_bSimpleProjection; // 0x7f5            
            // metadata: MNetworkEnable
            bool m_bLightOnlyTarget; // 0x7f6            
            // metadata: MNetworkEnable
            bool m_bLightWorld; // 0x7f7            
            // metadata: MNetworkEnable
            bool m_bCameraSpace; // 0x7f8            
            uint8_t _pad07f9[0x3]; // 0x7f9
            // metadata: MNetworkEnable
            float m_flBrightnessScale; // 0x7fc            
            // metadata: MNetworkEnable
            Color m_LightColor; // 0x800            
            // metadata: MNetworkEnable
            float m_flIntensity; // 0x804            
            // metadata: MNetworkEnable
            float m_flLinearAttenuation; // 0x808            
            // metadata: MNetworkEnable
            float m_flQuadraticAttenuation; // 0x80c            
            // metadata: MNetworkEnable
            bool m_bVolumetric; // 0x810            
            uint8_t _pad0811[0x3]; // 0x811
            // metadata: MNetworkEnable
            float m_flNoiseStrength; // 0x814            
            // metadata: MNetworkEnable
            float m_flFlashlightTime; // 0x818            
            // metadata: MNetworkEnable
            std::uint32_t m_nNumPlanes; // 0x81c            
            // metadata: MNetworkEnable
            float m_flPlaneOffset; // 0x820            
            // metadata: MNetworkEnable
            float m_flVolumetricIntensity; // 0x824            
            // metadata: MNetworkEnable
            float m_flColorTransitionTime; // 0x828            
            // metadata: MNetworkEnable
            float m_flAmbient; // 0x82c            
            // metadata: MNetworkEnable
            char m_SpotlightTextureName[512]; // 0x830            
            // metadata: MNetworkEnable
            std::int32_t m_nSpotlightTextureFrame; // 0xa30            
            // metadata: MNetworkEnable
            std::uint32_t m_nShadowQuality; // 0xa34            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "16"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "500,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_flNearZ; // 0xa38            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "18"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "1500,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_flFarZ; // 0xa3c            
            // metadata: MNetworkEnable
            float m_flProjectionSize; // 0xa40            
            // metadata: MNetworkEnable
            float m_flRotation; // 0xa44            
            // metadata: MNetworkEnable
            bool m_bFlipHorizontal; // 0xa48            
            uint8_t _pad0a49[0x7];
        ...
        static_assert(sizeof(source2sdk::server::CEnvProjectedTexture) == 0xa50);
    };
};
