...
#include "source2sdk/server/CSNetworkableLoadout_t.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVectorEmbeddedNetworkVar<source2sdk::client::ServerAuthoritativeWeaponSlot_t> m_vecServerAuthoritativeWeaponSlots;
            char m_vecServerAuthoritativeWeaponSlots[0x88]; // 0xf50            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnNetworkableLoadoutChanged"
            ...
            // CUtlVectorEmbeddedNetworkVar<source2sdk::server::CSNetworkableLoadout_t> m_vecNetworkableLoadout;
            char m_vecNetworkableLoadout[0x88]; // 0xfd8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayerController_InventoryServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCSPlayerController_InventoryServices) == 0x1060);
    };
};
