...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSoundscape[0x4]; // 0x9b8            
            uint8_t _pad09bc[0x4]; // 0x9bc
            CUtlSymbolLarge m_SoundscapeName; // 0x9c0            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerSoundscape) == 0x9e0);
    };
};
