...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hPositionKeys[0x8]; // 0x7f0            
            // metadata: MNetworkEnable
            ...
            char m_hRotationKeys[0x8]; // 0x7f8            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMin; // 0x800            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMax; // 0x80c            
            // metadata: MNetworkEnable
            float m_flStartTime; // 0x818            
            // metadata: MNetworkEnable
            float m_flStartFrame; // 0x81c            
        ...
        static_assert(sizeof(source2sdk::server::CTextureBasedAnimatable) == 0x820);
    };
};
