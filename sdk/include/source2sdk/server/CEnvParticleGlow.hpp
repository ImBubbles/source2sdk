...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flAlphaScale; // 0xd60            
            // metadata: MNetworkEnable
            float m_flRadiusScale; // 0xd64            
            // metadata: MNetworkEnable
            float m_flSelfIllumScale; // 0xd68            
            // metadata: MNetworkEnable
            Color m_ColorTint; // 0xd6c            
            // metadata: MNetworkEnable
            ...
            char m_hTextureOverride[0x8]; // 0xd70            
        ...
        static_assert(sizeof(source2sdk::server::CEnvParticleGlow) == 0xd78);
    };
};
