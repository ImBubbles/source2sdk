...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_traceResults[0x18]; // 0x6a8            
            ...
            char m_doorwayPairs[0x18]; // 0x6c0            
            float m_flSize; // 0x6d8            
            float m_flHeightTolerance; // 0x6dc            
            float m_flSizeSqr; // 0x6e0            
        ...
        static_assert(sizeof(source2sdk::server::CSoundOpvarSetAutoRoomEntity) == 0x6e8);
    };
};
