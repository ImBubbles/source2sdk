...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad06a8[0x18]; // 0x6a8
            float m_flDistMinSqr; // 0x6c0            
            float m_flDistMaxSqr; // 0x6c4            
            CUtlSymbolLarge m_iszPathCornerEntityName; // 0x6c8            
        ...
        static_assert(sizeof(source2sdk::server::CSoundOpvarSetPathCornerEntity) == 0x6d0);
    };
};
