...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flRange; // 0x5fc            
            std::int32_t m_nImportance; // 0x600            
            std::int32_t m_nLightChoice; // 0x604            
        ...
        static_assert(sizeof(source2sdk::client::CInfoDynamicShadowHint) == 0x610);
    };
};
