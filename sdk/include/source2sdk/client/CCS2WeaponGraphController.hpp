...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_weaponCategory[0x20]; // 0xb8            
            ...
            char m_weaponExtraInfo[0x20]; // 0xf8            
            ...
            char m_inspectExtraInfo[0x20]; // 0x240            
            ...
            char m_reloadStage[0x20]; // 0x260            
            uint8_t _pad0280[0x368];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCS2WeaponGraphController because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCS2WeaponGraphController) == 0x5e8);
    };
};
