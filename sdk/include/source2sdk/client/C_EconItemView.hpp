...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::client::CAttributeList m_NetworkedDynamicAttributes; // 0x288            
            // metadata: MNetworkEnable
            char m_szCustomName[161]; // 0x300            
            char m_szCustomNameOverride[161]; // 0x3a1            
            uint8_t _pad0442[0x2e]; // 0x442
            bool m_bInitializedTags; // 0x470            
            uint8_t _pad0471[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EconItemView because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EconItemView) == 0x478);
    };
};
