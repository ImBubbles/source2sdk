...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hDefuserMultimeter[0x4]; // 0x16a8            
            source2sdk::entity2::GameTime_t m_flNextRadarFlashTime; // 0x16ac            
            bool m_bRadarFlash; // 0x16b0            
            ...
            char m_pBombDefuser[0x4]; // 0x16b4            
            source2sdk::entity2::GameTime_t m_fLastDefuseTime; // 0x16b8            
            uint8_t _pad16bc[0x4]; // 0x16bc
            source2sdk::client::CBasePlayerController* m_pPredictionOwner; // 0x16c0            
            Vector m_vecC4ExplodeSpectatePos; // 0x16c8            
            QAngle m_vecC4ExplodeSpectateAng; // 0x16d4            
            float m_flC4ExplodeSpectateDuration; // 0x16e0            
        ...
        static_assert(sizeof(source2sdk::client::C_PlantedC4) == 0x16e8);
    };
};
