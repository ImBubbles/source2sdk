...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad05f8[0x8]; // 0x5f8
            bool m_bStartActive; // 0x600            
            uint8_t _pad0601[0x3]; // 0x601
            float m_flMaxSimulationTime; // 0x604            
            CUtlSymbolLarge m_iszEffectName; // 0x608            
            ...
            char m_PathNodes_Name[0x18]; // 0x610            
            // metadata: MNetworkEnable
            float m_flParticleSpacing; // 0x628            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "parametersChanged"
            float m_flSlack; // 0x62c            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "parametersChanged"
            float m_flRadius; // 0x630            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "parametersChanged"
            Color m_ColorTint; // 0x634            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "effectStateChanged"
            std::int32_t m_nEffectState; // 0x638            
            ...
            char m_PathNodes_Position[0x18]; // 0x648            
            // metadata: MNetworkEnable
            ...
            char m_PathNodes_TangentIn[0x18]; // 0x660            
            // metadata: MNetworkEnable
            ...
            char m_PathNodes_Color[0x18]; // 0x690            
            // metadata: MNetworkEnable
            ...
            char m_PathNodes_PinEnabled[0x18]; // 0x6a8            
            // metadata: MNetworkEnable
            ...
            char m_PathNodes_RadiusScale[0x18]; // 0x6c0            
            uint8_t _pad06d8[0x30];
        ...
        static_assert(sizeof(source2sdk::client::C_PathParticleRope) == 0x708);
    };
};
