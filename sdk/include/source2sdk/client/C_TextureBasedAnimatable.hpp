...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hPositionKeys[0x8]; // 0xec8            
            // metadata: MNetworkEnable
            ...
            char m_hRotationKeys[0x8]; // 0xed0            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMin; // 0xed8            
            // metadata: MNetworkEnable
            Vector m_vAnimationBoundsMax; // 0xee4            
            // metadata: MNetworkEnable
            float m_flStartTime; // 0xef0            
            // metadata: MNetworkEnable
            float m_flStartFrame; // 0xef4            
        ...
        static_assert(sizeof(source2sdk::client::C_TextureBasedAnimatable) == 0xef8);
    };
};
