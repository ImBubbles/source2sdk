...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::fogparams_t m_fog; // 0x5f8            
            bool m_bUseAngles; // 0x660            
            uint8_t _pad0661[0x3]; // 0x661
            std::int32_t m_iChangedVariables; // 0x664            
        ...
        static_assert(sizeof(source2sdk::client::C_FogController) == 0x668);
    };
};
