...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nDecoyShotTick; // 0x1460            
            std::int32_t m_nClientLastKnownDecoyShotTick; // 0x1464            
            uint8_t _pad1468[0x20]; // 0x1468
            source2sdk::entity2::GameTime_t m_flTimeParticleEffectSpawn; // 0x1488            
        ...
        static_assert(sizeof(source2sdk::client::C_DecoyProjectile) == 0x1490);
    };
};
