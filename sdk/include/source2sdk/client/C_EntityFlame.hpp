...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hOldAttached[0x4]; // 0x620            
            // metadata: MNetworkEnable
            bool m_bCheapEffect; // 0x624            
            uint8_t _pad0625[0x1b];
            
            // Datamap fields:
            // void m_hEffect; // 0x600
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EntityFlame because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EntityFlame) == 0x640);
    };
};
