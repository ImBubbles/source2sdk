...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flAutoExposureMin; // 0x5f8            
            // metadata: MNetworkEnable
            float m_flAutoExposureMax; // 0x5fc            
            // metadata: MNetworkEnable
            float m_flExposureAdaptationSpeedUp; // 0x600            
            // metadata: MNetworkEnable
            float m_flExposureAdaptationSpeedDown; // 0x604            
            // metadata: MNetworkEnable
            float m_flTonemapEVSmoothingRange; // 0x608            
        ...
        static_assert(sizeof(source2sdk::client::C_TonemapController2) == 0x610);
    };
};
