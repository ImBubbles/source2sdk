...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // Datamap fields:
            // CCSObserver_ObserverServices m_pObserverServices; // 0x1418
            // CCSObserver_MovementServices m_pMovementServices; // 0x1440
            // CCSObserver_UseServices m_pUseServices; // 0x1428
            // CCSObserver_CameraServices m_pCameraServices; // 0x1438
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_CSObserverPawn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_CSObserverPawn) == 0x16c0);
    };
};
