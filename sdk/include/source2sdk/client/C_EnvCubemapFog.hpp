...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flEndDistance; // 0x5f8            
            // metadata: MNetworkEnable
            float m_flStartDistance; // 0x5fc            
            // metadata: MNetworkEnable
            float m_flFogFalloffExponent; // 0x600            
            // metadata: MNetworkEnable
            bool m_bHeightFogEnabled; // 0x604            
            uint8_t _pad0605[0x3]; // 0x605
            // metadata: MNetworkEnable
            float m_flFogHeightWidth; // 0x608            
            // metadata: MNetworkEnable
            float m_flFogHeightEnd; // 0x60c            
            // metadata: MNetworkEnable
            float m_flFogHeightStart; // 0x610            
            // metadata: MNetworkEnable
            float m_flFogHeightExponent; // 0x614            
            // metadata: MNetworkEnable
            float m_flLODBias; // 0x618            
            // metadata: MNetworkEnable
            bool m_bActive; // 0x61c            
            // metadata: MNetworkEnable
            bool m_bStartDisabled; // 0x61d            
            uint8_t _pad061e[0x2]; // 0x61e
            // metadata: MNetworkEnable
            float m_flFogMaxOpacity; // 0x620            
            // metadata: MNetworkEnable
            std::int32_t m_nCubemapSourceType; // 0x624            
            // metadata: MNetworkEnable
            ...
            char m_hSkyMaterial[0x8]; // 0x628            
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_iszSkyEntity; // 0x630            
            // metadata: MNetworkEnable
            ...
            char m_hFogCubemapTexture[0x8]; // 0x638            
            // metadata: MNetworkEnable
            bool m_bHasHeightFogEnd; // 0x640            
            bool m_bFirstTime; // 0x641            
            uint8_t _pad0642[0x6];
        ...
        static_assert(sizeof(source2sdk::client::C_EnvCubemapFog) == 0x648);
    };
};
