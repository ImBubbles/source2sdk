...
#include "source2sdk/client/CSNetworkableLoadout_t.hpp"
...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecServerAuthoritativeWeaponSlots[0x68]; // 0x70            
            // metadata: MNetworkEnable
            ...
            // C_UtlVectorEmbeddedNetworkVar<source2sdk::client::CSNetworkableLoadout_t> m_vecNetworkableLoadout;
            char m_vecNetworkableLoadout[0x68]; // 0xd8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayerController_InventoryServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCSPlayerController_InventoryServices) == 0x140);
    };
};
