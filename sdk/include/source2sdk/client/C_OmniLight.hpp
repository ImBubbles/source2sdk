...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flInnerAngle; // 0x1210            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RenderingChanged"
            float m_flOuterAngle; // 0x1214            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RenderingChanged"
            bool m_bShowLight; // 0x1218            
            uint8_t _pad1219[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OmniLight because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_OmniLight) == 0x1220);
    };
};
