...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nShape; // 0x618            
            // metadata: MNetworkEnable
            float m_fWindSpeedMultiplier; // 0x61c            
            // metadata: MNetworkEnable
            float m_fWindTurbulenceMultiplier; // 0x620            
            // metadata: MNetworkEnable
            float m_fWindSpeedVariationMultiplier; // 0x624            
            // metadata: MNetworkEnable
            float m_fWindDirectionVariationMultiplier; // 0x628            
        ...
        static_assert(sizeof(source2sdk::client::C_EnvWindVolume) == 0x630);
    };
};
