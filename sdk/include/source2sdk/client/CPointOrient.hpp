...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            CUtlSymbolLarge m_iszSpawnTargetName; // 0x5f8            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x600            
            bool m_bActive; // 0x604            
            uint8_t _pad0605[0x3]; // 0x605
            source2sdk::client::PointOrientGoalDirectionType_t m_nGoalDirection; // 0x608            
            source2sdk::client::PointOrientConstraint_t m_nConstraint; // 0x60c            
            float m_flMaxTurnRate; // 0x610            
            source2sdk::entity2::GameTime_t m_flLastGameTime; // 0x614            
        ...
        static_assert(sizeof(source2sdk::client::CPointOrient) == 0x618);
    };
};
