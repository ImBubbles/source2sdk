...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bIsPlayingBack; // 0x600            
            // metadata: MNetworkEnable
            bool m_bPaused; // 0x601            
            // metadata: MNetworkEnable
            bool m_bMultiplayer; // 0x602            
            // metadata: MNetworkEnable
            bool m_bAutogenerated; // 0x603            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnResetClientTime"
            float m_flForceClientTime; // 0x604            
            // metadata: MNetworkEnable
            // metadata: MNetworkPriority "32"
            std::uint16_t m_nSceneStringIndex; // 0x608            
            bool m_bClientOnly; // 0x60a            
            uint8_t _pad060b[0x1]; // 0x60b
            // m_hOwner has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseFlex> m_hOwner;
            char m_hOwner[0x4]; // 0x60c            
            // metadata: MNetworkEnable
            // metadata: MNetworkPriority "32"
