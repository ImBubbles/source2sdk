...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_iExternalItemProviderRegisteredToken; // 0x4c8            
            uint8_t _pad04cc[0x4]; // 0x4cc
            std::uint64_t m_ullRegisteredAsItemID; // 0x4d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_AttributeContainer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_AttributeContainer) == 0x4d8);
    };
};
