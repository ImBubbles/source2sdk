...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flScattering; // 0x5f8            
            // metadata: MNetworkEnable
            Color m_TintColor; // 0x5fc            
            // metadata: MNetworkEnable
            float m_flAnisotropy; // 0x600            
            // metadata: MNetworkEnable
            float m_flFadeSpeed; // 0x604            
            // metadata: MNetworkEnable
            float m_flDrawDistance; // 0x608            
            // metadata: MNetworkEnable
            float m_flFadeInStart; // 0x60c            
            // metadata: MNetworkEnable
            float m_flFadeInEnd; // 0x610            
            // metadata: MNetworkEnable
            float m_flIndirectStrength; // 0x614            
            // metadata: MNetworkEnable
            std::int32_t m_nVolumeDepth; // 0x618            
            // metadata: MNetworkEnable
            float m_fFirstVolumeSliceThickness; // 0x61c            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimX; // 0x620            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimY; // 0x624            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimZ; // 0x628            
            // metadata: MNetworkEnable
            Vector m_vBoxMins; // 0x62c            
            // metadata: MNetworkEnable
            Vector m_vBoxMaxs; // 0x638            
            // metadata: MNetworkEnable
            bool m_bActive; // 0x644            
            uint8_t _pad0645[0x3]; // 0x645
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartAnisoTime; // 0x648            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartScatterTime; // 0x64c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartDrawDistanceTime; // 0x650            
            // metadata: MNetworkEnable
            float m_flStartAnisotropy; // 0x654            
            // metadata: MNetworkEnable
            float m_flStartScattering; // 0x658            
            // metadata: MNetworkEnable
            float m_flStartDrawDistance; // 0x65c            
            // metadata: MNetworkEnable
            float m_flDefaultAnisotropy; // 0x660            
            // metadata: MNetworkEnable
            float m_flDefaultScattering; // 0x664            
            // metadata: MNetworkEnable
            float m_flDefaultDrawDistance; // 0x668            
            // metadata: MNetworkEnable
            bool m_bStartDisabled; // 0x66c            
            // metadata: MNetworkEnable
            bool m_bEnableIndirect; // 0x66d            
            // metadata: MNetworkEnable
            bool m_bIsMaster; // 0x66e            
            uint8_t _pad066f[0x1]; // 0x66f
            // metadata: MNetworkEnable
            ...
            char m_hFogIndirectTexture[0x8]; // 0x670            
            // metadata: MNetworkEnable
            std::int32_t m_nForceRefreshCount; // 0x678            
            // metadata: MNetworkEnable
            float m_fNoiseSpeed; // 0x67c            
            // metadata: MNetworkEnable
            float m_fNoiseStrength; // 0x680            
            // metadata: MNetworkEnable
            Vector m_vNoiseScale; // 0x684            
            // metadata: MNetworkEnable
            float m_fWindSpeed; // 0x690            
            // metadata: MNetworkEnable
            Vector m_vWindDirection; // 0x694            
            bool m_bFirstTime; // 0x6a0            
        ...
        static_assert(sizeof(source2sdk::client::C_EnvVolumetricFogController) == 0x6a8);
    };
};
