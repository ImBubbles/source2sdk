...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::C_EnvWindShared m_EnvWindShared; // 0x5f8            
            // metadata: MNetworkEnable
            float m_fDirectionVariation; // 0x6f0            
            // metadata: MNetworkEnable
            float m_fSpeedVariation; // 0x6f4            
            // metadata: MNetworkEnable
            float m_fTurbulence; // 0x6f8            
            // metadata: MNetworkEnable
            float m_fVolumeHalfExtentXY; // 0x6fc            
            // metadata: MNetworkEnable
            float m_fVolumeHalfExtentZ; // 0x700            
            // metadata: MNetworkEnable
            std::int32_t m_nVolumeResolutionXY; // 0x704            
            // metadata: MNetworkEnable
            std::int32_t m_nVolumeResolutionZ; // 0x708            
            // metadata: MNetworkEnable
            std::int32_t m_nClipmapLevels; // 0x70c            
            // metadata: MNetworkEnable
            bool m_bIsMaster; // 0x710            
            bool m_bFirstTime; // 0x711            
            uint8_t _pad0712[0x6];
        ...
        static_assert(sizeof(source2sdk::client::C_EnvWindController) == 0x718);
    };
};
