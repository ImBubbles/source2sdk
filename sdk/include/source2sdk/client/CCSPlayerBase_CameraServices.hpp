...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::uint32_t m_iFOV; // 0x288            
            // metadata: MNetworkEnable
            std::uint32_t m_iFOVStart; // 0x28c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flFOVTime; // 0x290            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            float m_flFOVRate; // 0x294            
            // metadata: MNetworkEnable
            ...
            char m_hZoomOwner[0x4]; // 0x298            
            float m_flLastShotFOV; // 0x29c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayerBase_CameraServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCSPlayerBase_CameraServices) == 0x2a0);
    };
};
