...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_aPlayerControllers[0x18]; // 0x5f8            
            // metadata: MNetworkEnable
            ...
            char m_aPlayers[0x18]; // 0x610            
            // metadata: MNetworkEnable
            std::int32_t m_iScore; // 0x628            
            // metadata: MNetworkEnable
            char m_szTeamname[129]; // 0x62c            
        ...
        static_assert(sizeof(source2sdk::client::C_Team) == 0x6b0);
    };
};
