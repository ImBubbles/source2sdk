...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::uint8_t m_Flags; // 0xec0            
            // metadata: MNetworkEnable
            std::uint8_t m_LightStyle; // 0xec1            
            uint8_t _pad0ec2[0x2]; // 0xec2
            // metadata: MNetworkEnable
            float m_Radius; // 0xec4            
            // metadata: MNetworkEnable
            std::int32_t m_Exponent; // 0xec8            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            float m_InnerAngle; // 0xecc            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "360,000000"
            float m_OuterAngle; // 0xed0            
            // metadata: MNetworkEnable
            float m_SpotRadius; // 0xed4            
            uint8_t _pad0ed8[0x10];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DynamicLight because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DynamicLight) == 0xee8);
    };
};
