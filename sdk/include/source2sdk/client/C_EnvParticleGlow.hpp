...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flAlphaScale; // 0x1470            
            // metadata: MNetworkEnable
            float m_flRadiusScale; // 0x1474            
            // metadata: MNetworkEnable
            float m_flSelfIllumScale; // 0x1478            
            // metadata: MNetworkEnable
            Color m_ColorTint; // 0x147c            
            // metadata: MNetworkEnable
            ...
            char m_hTextureOverride[0x8]; // 0x1480            
        ...
        static_assert(sizeof(source2sdk::client::C_EnvParticleGlow) == 0x1488);
    };
};
