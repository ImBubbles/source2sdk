...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_activeLightParticleIndex; // 0x1e10            
            source2sdk::client::C4LightEffect_t m_eActiveLightEffect; // 0x1e14            
            // metadata: MNetworkEnable
            bool m_bStartedArming; // 0x1e18            
            uint8_t _pad1e19[0x3]; // 0x1e19
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_fArmedTime; // 0x1e1c            
            // metadata: MNetworkEnable
            bool m_bBombPlacedAnimation; // 0x1e20            
            // metadata: MNetworkEnable
            bool m_bIsPlantingViaUse; // 0x1e21            
            uint8_t _pad1e22[0x6]; // 0x1e22
            // metadata: MNetworkEnable
            source2sdk::client::EntitySpottedState_t m_entitySpottedState; // 0x1e28            
            std::int32_t m_nSpotRules; // 0x1e40            
            bool m_bPlayedArmingBeeps[7]; // 0x1e44            
            bool m_bBombPlanted; // 0x1e4b            
        ...
        static_assert(sizeof(source2sdk::client::C_C4) == 0x1e50);
    };
};
