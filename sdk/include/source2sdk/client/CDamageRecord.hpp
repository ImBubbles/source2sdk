...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_iBulletsDamage; // 0x60            
            // metadata: MNetworkEnable
            std::int32_t m_iDamage; // 0x64            
            // metadata: MNetworkEnable
            std::int32_t m_iActualHealthRemoved; // 0x68            
            // metadata: MNetworkEnable
        ...
        static_assert(offsetof(source2sdk::client::CDamageRecord, m_iBulletsDamage) == 0x60);
        static_assert(offsetof(source2sdk::client::CDamageRecord, m_iDamage) == 0x64);
        static_assert(offsetof(source2sdk::client::CDamageRecord, m_iActualHealthRemoved) == 0x68);
