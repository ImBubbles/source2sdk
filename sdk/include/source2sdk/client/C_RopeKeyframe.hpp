...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LinksTouchingSomething[0x4]; // 0xec8            
            std::int32_t m_nLinksTouchingSomething; // 0xecc            
            bool m_bApplyWind; // 0xed0            
            uint8_t _pad0ed1[0x3]; // 0xed1
            std::int32_t m_fPrevLockedPoints; // 0xed4            
            std::int32_t m_iForcePointMoveCounter; // 0xed8            
            bool m_bPrevEndPointPos[2]; // 0xedc            
            uint8_t _pad0ede[0x2]; // 0xede
            Vector m_vPrevEndPointPos[2]; // 0xee0            
            float m_flCurScroll; // 0xef8            
            // metadata: MNetworkEnable
            float m_flScrollSpeed; // 0xefc            
            // metadata: MNetworkEnable
            std::uint16_t m_RopeFlags; // 0xf00            
            uint8_t _pad0f02[0x6]; // 0xf02
            // metadata: MNetworkEnable
            ...
            char m_iRopeMaterialModelIndex[0x8]; // 0xf08            
            uint8_t _pad0f10[0x270]; // 0xf10
            // metadata: MNetworkEnable
            std::uint8_t m_nSegments; // 0x1180            
            ...
            char m_hEndPoint[0x4]; // 0x1188            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_iStartAttachment; // 0x118c            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_iEndAttachment; // 0x118d            
            // metadata: MNetworkEnable
            std::uint8_t m_Subdiv; // 0x118e            
            uint8_t _pad118f[0x1]; // 0x118f
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RecomputeSprings"
            std::int16_t m_RopeLength; // 0x1190            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "RecomputeSprings"
            std::int16_t m_Slack; // 0x1192            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "10"
            // metadata: MNetworkMinValue "0,100000"
            // metadata: MNetworkMaxValue "10,000000"
            float m_TextureScale; // 0x1194            
            // metadata: MNetworkEnable
            std::uint8_t m_fLockedPoints; // 0x1198            
            // metadata: MNetworkEnable
            std::uint8_t m_nChangeCount; // 0x1199            
            uint8_t _pad119a[0x2]; // 0x119a
            // metadata: MNetworkEnable
            float m_Width; // 0x119c            
            source2sdk::client::C_RopeKeyframe_CPhysicsDelegate m_PhysicsDelegate; // 0x11a0            
            ...
            char m_hMaterial[0x8]; // 0x11b0            
            std::int32_t m_TextureHeight; // 0x11b8            
            Vector m_vecImpulse; // 0x11bc            
            Vector m_vecPreviousImpulse; // 0x11c8            
            float m_flCurrentGustTimer; // 0x11d4            
            float m_flCurrentGustLifetime; // 0x11d8            
            float m_flTimeToNextGust; // 0x11dc            
            Vector m_vWindDir; // 0x11e0            
            Vector m_vColorMod; // 0x11ec            
            Vector m_vCachedEndPointAttachmentPos[2]; // 0x11f8            
            QAngle m_vCachedEndPointAttachmentAngle[2]; // 0x1210            
            // metadata: MNetworkEnable
            bool m_bConstrainBetweenEndpoints; // 0x1228            
