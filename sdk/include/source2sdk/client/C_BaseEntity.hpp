...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            uint8_t _pad05d4[0x9]; // 0x5d4
            bool m_bAnimTimeChanged; // 0x5dd            
            bool m_bSimulationTimeChanged; // 0x5de            
            uint8_t _pad05df[0x9]; // 0x5df
            CUtlString m_sUniqueHammerID; // 0x5e8            
            // metadata: MNetworkEnable
            source2sdk::client::BloodType m_nBloodType; // 0x5f0            
        ...
        static_assert(sizeof(source2sdk::client::C_BaseEntity) == 0x5f8);
    };
};
