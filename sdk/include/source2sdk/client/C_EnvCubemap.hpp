...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_Entity_hCubemapTexture[0x8]; // 0x678            
            // metadata: MNetworkEnable
            bool m_Entity_bCustomCubemapTexture; // 0x680            
            uint8_t _pad0681[0x3]; // 0x681
            // metadata: MNetworkEnable
            float m_Entity_flInfluenceRadius; // 0x684            
            // metadata: MNetworkEnable
            Vector m_Entity_vBoxProjectMins; // 0x688            
            // metadata: MNetworkEnable
            Vector m_Entity_vBoxProjectMaxs; // 0x694            
            // metadata: MNetworkEnable
            bool m_Entity_bMoveable; // 0x6a0            
            uint8_t _pad06a1[0x3]; // 0x6a1
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nHandshake; // 0x6a4            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nEnvCubeMapArrayIndex; // 0x6a8            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nPriority; // 0x6ac            
            // metadata: MNetworkEnable
            float m_Entity_flEdgeFadeDist; // 0x6b0            
            // metadata: MNetworkEnable
            Vector m_Entity_vEdgeFadeDists; // 0x6b4            
            // metadata: MNetworkEnable
            float m_Entity_flDiffuseScale; // 0x6c0            
            // metadata: MNetworkEnable
            bool m_Entity_bStartDisabled; // 0x6c4            
            // metadata: MNetworkEnable
            bool m_Entity_bDefaultEnvMap; // 0x6c5            
            // metadata: MNetworkEnable
            bool m_Entity_bDefaultSpecEnvMap; // 0x6c6            
            // metadata: MNetworkEnable
            bool m_Entity_bIndoorCubeMap; // 0x6c7            
            // metadata: MNetworkEnable
            bool m_Entity_bCopyDiffuseFromDefaultCubemap; // 0x6c8            
            uint8_t _pad06c9[0xf]; // 0x6c9
            // metadata: MNetworkEnable
            bool m_Entity_bEnabled; // 0x6d8            
            uint8_t _pad06d9[0x7];
            
            // Datamap fields:
            // void m_Entity_pSceneObject; // 0x6d0
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EnvCubemap because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EnvCubemap) == 0x6e0);
    };
};
