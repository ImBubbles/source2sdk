...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_szTeamMatchStat[512]; // 0x6b0            
            // metadata: MNetworkEnable
            std::int32_t m_numMapVictories; // 0x8b0            
            // metadata: MNetworkEnable
            bool m_bSurrendered; // 0x8b4            
            uint8_t _pad08b5[0x3]; // 0x8b5
            // metadata: MNetworkEnable
            std::int32_t m_scoreFirstHalf; // 0x8b8            
            // metadata: MNetworkEnable
            std::int32_t m_scoreSecondHalf; // 0x8bc            
            // metadata: MNetworkEnable
            std::int32_t m_scoreOvertime; // 0x8c0            
            // metadata: MNetworkEnable
            char m_szClanTeamname[129]; // 0x8c4            
            uint8_t _pad0945[0x3]; // 0x945
            // metadata: MNetworkEnable
            std::uint32_t m_iClanID; // 0x948            
            // metadata: MNetworkEnable
            char m_szTeamFlagImage[8]; // 0x94c            
            // metadata: MNetworkEnable
            char m_szTeamLogoImage[8]; // 0x954            
        ...
        static_assert(sizeof(source2sdk::client::C_CSTeam) == 0x960);
    };
};
