...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flTouchDelta; // 0x1310            
            source2sdk::entity2::GameTime_t m_fDeathTime; // 0x1314            
            Vector m_vecDamagePosition; // 0x1318            
            Vector m_vecDamageDirection; // 0x1324            
            source2sdk::client::DamageTypes_t m_nDamageType; // 0x1330            
            uint8_t _pad1334[0xc];
        ...
        static_assert(sizeof(source2sdk::client::C_PhysPropClientside) == 0x1340);
    };
};
