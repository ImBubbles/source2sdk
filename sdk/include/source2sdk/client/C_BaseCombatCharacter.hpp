...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hMyWearables[0x18]; // 0x1378            
            source2sdk::modellib::AttachmentHandle_t m_leftFootAttachment; // 0x1390            
            source2sdk::modellib::AttachmentHandle_t m_rightFootAttachment; // 0x1391            
            uint8_t _pad1392[0x2]; // 0x1392
            source2sdk::client::C_BaseCombatCharacter_WaterWakeMode_t m_nWaterWakeMode; // 0x1394            
            float m_flWaterWorldZ; // 0x1398            
            float m_flWaterNextTraceTime; // 0x139c            
            uint8_t _pad13a0[0x60];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_BaseCombatCharacter because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_BaseCombatCharacter) == 0x1400);
    };
};
