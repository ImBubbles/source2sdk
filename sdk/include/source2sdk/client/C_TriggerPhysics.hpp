...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_gravityScale; // 0x1000            
            // metadata: MNetworkEnable
            float m_linearLimit; // 0x1004            
            // metadata: MNetworkEnable
            float m_linearDamping; // 0x1008            
            // metadata: MNetworkEnable
            float m_angularLimit; // 0x100c            
            // metadata: MNetworkEnable
            float m_angularDamping; // 0x1010            
            // metadata: MNetworkEnable
            float m_linearForce; // 0x1014            
            // metadata: MNetworkEnable
            float m_flFrequency; // 0x1018            
            // metadata: MNetworkEnable
            float m_flDampingRatio; // 0x101c            
            // metadata: MNetworkEnable
            Vector m_vecLinearForcePointAt; // 0x1020            
            // metadata: MNetworkEnable
            bool m_bCollapseToForcePoint; // 0x102c            
            uint8_t _pad102d[0x3]; // 0x102d
            // metadata: MNetworkEnable
            Vector m_vecLinearForcePointAtWorld; // 0x1030            
            // metadata: MNetworkEnable
            Vector m_vecLinearForceDirection; // 0x103c            
            // metadata: MNetworkEnable
            bool m_bConvertToDebrisWhenPossible; // 0x1048            
        ...
        static_assert(sizeof(source2sdk::client::C_TriggerPhysics) == 0x1050);
    };
};
