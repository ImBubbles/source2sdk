...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_FOV; // 0x5f8            
            // metadata: MNetworkEnable
            float m_Resolution; // 0x5fc            
            // metadata: MNetworkEnable
            bool m_bFogEnable; // 0x600            
            // metadata: MNetworkEnable
            Color m_FogColor; // 0x601            
            uint8_t _pad0605[0x3]; // 0x605
            // metadata: MNetworkEnable
            float m_flFogStart; // 0x608            
            // metadata: MNetworkEnable
            float m_flFogEnd; // 0x60c            
            // metadata: MNetworkEnable
            float m_flFogMaxDensity; // 0x610            
            // metadata: MNetworkEnable
            bool m_bActive; // 0x614            
            // metadata: MNetworkEnable
            bool m_bUseScreenAspectRatio; // 0x615            
            uint8_t _pad0616[0x2]; // 0x616
            // metadata: MNetworkEnable
            float m_flAspectRatio; // 0x618            
            // metadata: MNetworkEnable
            bool m_bNoSky; // 0x61c            
            uint8_t _pad061d[0x3]; // 0x61d
            // metadata: MNetworkEnable
            float m_fBrightness; // 0x620            
            // metadata: MNetworkEnable
            float m_flZFar; // 0x624            
            // metadata: MNetworkEnable
            float m_flZNear; // 0x628            
            // metadata: MNetworkEnable
            bool m_bCanHLTVUse; // 0x62c            
            // metadata: MNetworkEnable
            bool m_bAlignWithParent; // 0x62d            
            // metadata: MNetworkEnable
            bool m_bDofEnabled; // 0x62e            
            uint8_t _pad062f[0x1]; // 0x62f
            // metadata: MNetworkEnable
