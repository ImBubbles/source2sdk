...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flVisibilityStrength; // 0x5f8            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "PlayerVisibilityStateChanged"
            float m_flFogDistanceMultiplier; // 0x5fc            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "PlayerVisibilityStateChanged"
            float m_flFogMaxDensityMultiplier; // 0x600            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "PlayerVisibilityStateChanged"
            float m_flFadeTime; // 0x604            
            // metadata: MNetworkEnable
            bool m_bStartDisabled; // 0x608            
            // metadata: MNetworkEnable
            bool m_bIsEnabled; // 0x609            
            uint8_t _pad060a[0x1e];
        ...
        static_assert(sizeof(source2sdk::client::C_PlayerVisibility) == 0x628);
    };
};
