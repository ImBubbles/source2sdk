...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::client::WeaponPurchaseTracker_t m_weaponPurchasesThisRound; // 0xb8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCSPlayer_ActionTrackingServices because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCSPlayer_ActionTrackingServices) == 0x128);
    };
};
