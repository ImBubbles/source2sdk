...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bLinkedCooldowns; // 0x3e4            
            source2sdk::client::ItemFlagTypes_t m_iFlags; // 0x3e5            
            ...
            source2sdk::client::AmmoIndex_t m_nPrimaryAmmoType; // 0x3e6            
            // metadata: MPropertyAttributeEditor "VDataChoice( scripts/ammo.vdata )"
            // metadata: MPropertyCustomFGDType "string"
            source2sdk::client::AmmoIndex_t m_nSecondaryAmmoType; // 0x3e7            
