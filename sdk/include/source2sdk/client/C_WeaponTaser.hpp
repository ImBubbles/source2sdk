...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_fFireTime; // 0x1e40            
            std::int32_t m_nLastAttackTick; // 0x1e44            
            uint8_t _pad1e48[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_WeaponTaser because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_WeaponTaser) == 0x1e50);
    };
};
