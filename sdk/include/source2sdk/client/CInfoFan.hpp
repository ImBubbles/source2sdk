...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            uint8_t _pad05f8[0x40]; // 0x5f8
            // metadata: MNetworkEnable
            float m_fFanForceMaxRadius; // 0x638            
            // metadata: MNetworkEnable
            float m_fFanForceMinRadius; // 0x63c            
            // metadata: MNetworkEnable
            float m_flCurveDistRange; // 0x640            
            uint8_t _pad0644[0x4]; // 0x644
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_FanForceCurveString; // 0x648            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CInfoFan because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CInfoFan) == 0x650);
    };
};
