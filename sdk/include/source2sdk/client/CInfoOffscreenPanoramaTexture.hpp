...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nResolutionX; // 0x5fc            
            // metadata: MNetworkEnable
            std::int32_t m_nResolutionY; // 0x600            
            ...
            uint8_t _pad0650[0x168]; // 0x650
            bool m_bCheckCSSClasses; // 0x7b8            
            uint8_t _pad07b9[0x27];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CInfoOffscreenPanoramaTexture because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CInfoOffscreenPanoramaTexture) == 0x7e0);
    };
};
