...
namespace source2sdk
{
    namespace compositematerialslib
    {
        ...
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_bSplatDebugInfo) == 0x305);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_bCaptureInRenderDoc) == 0x306);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_vecTexGenInstructions) == 0x308);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_vecConditionalMutators) == 0x320);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_strPopInputQueue_Container) == 0x338);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_strDrawText_InputContainerSrc) == 0x340);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_strDrawText_InputContainerProperty) == 0x348);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_vecDrawText_Position) == 0x350);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_colDrawText_Color) == 0x358);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_strDrawText_Font) == 0x360);
        static_assert(offsetof(source2sdk::compositematerialslib::CompMatPropertyMutator_t, m_vecConditions) == 0x368);
        
        static_assert(sizeof(source2sdk::compositematerialslib::CompMatPropertyMutator_t) == 0x380);
    };
};
